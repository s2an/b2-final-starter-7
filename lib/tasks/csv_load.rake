...
namespace :csv_load do
   ...
   task :all do 
      [:customers, :merchants, :invoices, :items, :invoice_items, :transactions].each do |task|
      # [:customers, :merchants, :coupons, :invoices, :items, :invoice_items, :transactions].each do |task|
